...
export default function ProjectPage() {
  ...
  const githubRepo = projectData && "github_repo" in projectData
    ? (projectData as { github_repo?: string | null }).github_repo ?? null
    : null;
    ...
    <div className="p-6">
      <div className="flex items-center justify-between gap-4 mb-1">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          aria-label={githubRepo ? "GitHub connected" : "Connect with GitHub"}
        >
          ...
          {githubRepo ? (
            <span className="font-medium text-text">{githubRepo}</span>
          ) : (
